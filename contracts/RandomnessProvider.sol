...
contract RandomnessProvider is VRFConsumerBaseV2Plus {
    ...
    mapping(uint256 => address)
        public s_requestToSender; /* requestId --> sender */
    ...
    {
        s_subscriptionId = 96974610044604628616312141700459175826277520099863534881940862707743682658212;
    }
        ...
        if (nftContract != address(0)) {
            (bool success, ) = nftContract.call(
                abi.encodeWithSignature(
                    "processRandomNumbers(addresss,uint256,uint256[])",
                    recipient,
                    _requestId,
                    _randomWords
                )
